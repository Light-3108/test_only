...
if __name__ == '__main__':
    ...
    agent_1 = make_agent(name='agent_1', env=venv, args=args, device=device)
    agent_2 = make_agent(name='agent_2', env=venv, args=args, device=device)
    adversary_agent, adversary_env = None, None
    if is_paired or args.use_accel_paired:
        adversary_agent_1 = make_agent(name='adversary_agent_1', env=venv, args=args, device=device)
        adversary_agent_2 = make_agent(name='adversary_agent_2', env=venv, args=args, device=device)
    if is_training_env:
